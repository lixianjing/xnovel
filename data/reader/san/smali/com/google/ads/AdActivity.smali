...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/google/ads/AdActivity;->c:Lb;
...
.method private a(Lg;ZI)V
    ...
    invoke-static {p1}, Lf;->a(Landroid/webkit/WebView;)V
...
.method public static launchAdActivity(Lb;Lc;)V
    .locals 4
    ...
    :try_start_0
    sget-object v1, Lcom/google/ads/AdActivity;->c:Lb;

    if-nez v1, :cond_1

    sput-object p0, Lcom/google/ads/AdActivity;->c:Lb;
    :try_end_0
    ...
    invoke-virtual {p1}, Lc;->a()Landroid/os/Bundle;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :try_start_0
    sget-object v2, Lcom/google/ads/AdActivity;->c:Lb;

    if-eqz v2, :cond_2

    sget-object v8, Lcom/google/ads/AdActivity;->c:Lb;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {v2, v1}, Lc;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {v2}, Lc;->b()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v2}, Lc;->c()Ljava/util/HashMap;
    ...
    sget-object v3, Lcom/google/ads/AdActivity;->c:Lb;

    if-eqz v3, :cond_a

    sget-object v3, Lcom/google/ads/AdActivity;->c:Lb;

    invoke-virtual {v3}, Lb;->t()V
    ...
    sget-object v2, Lf;->b:Ljava/util/Map;

    invoke-direct {v1, v8, v2, v9, v9}, Ln;-><init>(Lb;Ljava/util/Map;ZZ)V
...
.method public onDestroy()V
    ...
    invoke-static {v0}, Lf;->b(Landroid/webkit/WebView;)V
